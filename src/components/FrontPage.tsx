...
const FrontPage = () => {
  ...
  return (   
<div className='flex justify-center items-center my-10 mx-auto max-w-screen-xl w-full px-4'>
  ...
  <div className="absolute w-20 h-20 bg-blue-300 animate-rotate"></div>
